...
void Multigrid(){
    ofstream fout("MULTIGRID_TWO_LEVELS_residuals.txt");
...
//INITIALISING MATRICES FOR THE CYCLE
     E_H_1 = init(E_H_1); E_H_2 = init(E_H_2) ; 
//START OF THE CYCLE 
...
void printmatrix(){
            ...
            cout<<"The NODAL VLAUES are printed to : MULTIGRID_TWO_LEVELS_sol.txt"<<'\n';
            ofstream fout("MULTIGRID_TWO_LEVELS_sol.txt");
